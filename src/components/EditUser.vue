      ...
      <div class="modal-dialog">
          <div class="modal-content">
              <div class="modal-header">
                  <h5 class="modal-title" :id="`editUserLabel`+user.id">Edit Product</h5>
              ...
              <div class="modal-body">
                  <form method="PUT" @submit="editUser">
                      ...
                      <label class="form-label">User UserRole</label>
                      <input type="text" class="form-control" v-model="user.userRole">
                      <label class="form-label">User Email</label>
                      <input type="text" class="form-control" v-model="user.email">
                      <label class="form-label">Phone Number</label>
                      <input type="number" class="form-control" v-model="user.phonenumber">
                  </form>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn" data-bs-dismiss="modal">Close</button>
                
                <button type="button" @click="editUser" class="btn btn-primary" data-bs-dismiss="modal">Edit User</button>
              </div>
          </div>
      </div>
    </div>
